...
temp_DATABASE = {
	...
	bio3: {
		...
		rdt: {
			...
			'R30D': {name: 'Clock Tower Nemesis Fight', location: 'Clock Tower', saveRoom: !1},
			...
			'R600': {name: '(Merc) Warehouse Save Room', location: 'Uptown', saveRoom: !1},
			...
			'R61D': {name: '(Merc) Warehouse Alley', location: 'Uptown', saveRoom: !1},
			'R61E': {name: '(Merc) Warehouse Street', location: 'Uptown', saveRoom: !1},
			'R61F': {name: '(Merc) Basement Alley', location: 'Uptown', saveRoom: !1},
			'R620': {name: '(Merc) Bar Jack Alley', location: 'Uptown', saveRoom: !1},
			'R621': {name: '(Merc) Boutique Street', location: 'Uptown', saveRoom: !1},
			'R622': {name: '(Merc) Barricade Alley', location: 'Uptown', saveRoom: !1},
			'R623': {name: '(Merc) Hydrant Alley', location: 'Uptown', saveRoom: !1},
			'R624': {name: '(Merc) Main Street', location: 'Uptown', saveRoom: !1},
			'R700': {name: '(Merc) Bus Street', location: 'Downtown', saveRoom: !1},
			'R701': {name: '(Merc) Mechanic Parking Lot', location: 'Downtown', saveRoom: !1},
			'R702': {name: '(Merc) Parking Lot Back', location: 'Downtown', saveRoom: !1},
			'R703': {name: '(Merc) Construction Site', location: 'Downtown', saveRoom: !1},
			...
			'R709': {name: '(Merc) Party Party Alley', location: 'Downtown', saveRoom: !1},
			'R70A': {name: '(Merc) Giant Worm Alley', location: 'Downtown', saveRoom: !1},
			...
			'R718': {name: '(Merc) Fire Hose Alley', location: 'Uptown', saveRoom: !1},
			'R71A': {name: '(Merc) Parasite Alley4', location: 'Uptown', saveRoom: !1},
